  ...
  return (
    <CodeBlockPrimitive
      ...
      className={cn(
        ...
        '[&>pre]:!bg-transparent [&_code]:!bg-transparent [&>pre]:[background:transparent_!important] [&_code]:[background:transparent_!important] [&>pre]:border-none [&_code]:border-none [&_code]:!text-[13px] [&_code_.line]:!px-0',
        cursor &&
